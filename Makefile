...
KERNEL_COMMON_SRCS := $(KERNEL_SRC) klib/debug.c kernel/selftest.c kernel/cpu/cpu.c kernel/memory/pmm.c kernel/memory/vmm.c kernel/terminal/terminal.c klib/printf/printf.c klib/klib.c
