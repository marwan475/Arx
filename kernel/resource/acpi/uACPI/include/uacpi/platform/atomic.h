...
#define UACPI_MSVC_CMPXCHG_INVOKE(ptr, expected, desired, width, type) uacpi_do_atomic_cmpxchg##width((type volatile*) ptr, (type volatile*) expected, desired)

#define UACPI_MSVC_ATOMIC_STORE(ptr, value, type, width) _InterlockedExchange##width((type volatile*) (ptr), (type) (value))
...
#pragma aux uacpi_do_atomic_cmpxchg16     = ".486"                                                                                                                                                                                                                                                         \
                                            "mov ax, [esi]"                                                                                                                                                                                                                                                \
                                            "lock cmpxchg [edi], bx"                                                                                                                                                                                                                                       \
                                            "mov [esi], ax"                                                                                                                                                                                                                                                \
                                            "setz al"                                                                                                                                                                                                                                                      \
...
#pragma aux uacpi_do_atomic_cmpxchg32     = ".486"                                                                                                                                                                                                                                                         \
                                            "mov eax, [esi]"                                                                                                                                                                                                                                               \
...
#pragma aux uacpi_do_atomic_cmpxchg64_asm = ".586"                                                                                                                                                                                                                                                         \
                                            "mov eax, [esi]"                                                                                                                                                                                                                                               \
                                            "mov edx, [esi + 4]"                                                                                                                                                                                                                                           \
                                            "lock cmpxchg8b [edi]"                                                                                                                                                                                                                                         \
                                            "mov [esi], eax"                                                                                                                                                                                                                                               \
...
#define uacpi_atomic_cmpxchg16(ptr, expected, desired) uacpi_do_atomic_cmpxchg16((volatile uint16_t*) ptr, (volatile uint16_t*) expected, (uint16_t) desired)
#define uacpi_atomic_cmpxchg32(ptr, expected, desired) uacpi_do_atomic_cmpxchg32((volatile uint32_t*) ptr, (volatile uint32_t*) expected, (uint32_t) desired)
#define uacpi_atomic_cmpxchg64(ptr, expected, desired) uacpi_do_atomic_cmpxchg64((volatile uint64_t*) ptr, (volatile uint64_t*) expected, (uint64_t) desired)
...
#pragma aux uacpi_do_atomic_load64_asm = ".586"                                                                                                                                                                                                                                                            \
                                         "xor eax, eax"                                                                                                                                                                                                                                                    \
                                         "xor ebx, ebx"                                                                                                                                                                                                                                                    \
                                         "xor ecx, ecx"                                                                                                                                                                                                                                                    \
                                         "xor edx, edx"                                                                                                                                                                                                                                                    \
...
#pragma aux uacpi_do_atomic_store64_asm = ".586"                                                                                                                                                                                                                                                           \
                                          "xor eax, eax"                                                                                                                                                                                                                                                   \
                                          "xor edx, edx"                                                                                                                                                                                                                                                   \
...
#pragma aux uacpi_do_atomic_inc64_asm = ".586"                                                                                                                                                                                                                                                             \
                                        "xor eax, eax"                                                                                                                                                                                                                                                     \
                                        "xor edx, edx"                                                                                                                                                                                                                                                     \
                                        "mov ebx, 1"                                                                                                                                                                                                                                                       \
                                        "mov ecx, 1"                                                                                                                                                                                                                                                       \
...
#pragma aux uacpi_do_atomic_dec64_asm = ".586"                                                                                                                                                                                                                                                             \
                                        "xor eax, eax"                                                                                                                                                                                                                                                     \
                                        "xor edx, edx"                                                                                                                                                                                                                                                     \
                                        "mov ebx, -1"                                                                                                                                                                                                                                                      \
                                        "mov ecx, -1"                                                                                                                                                                                                                                                      \
...
#define UACPI_DO_CMPXCHG(ptr, expected, desired) __atomic_compare_exchange_n(ptr, expected, desired, 0, __ATOMIC_ACQ_REL, __ATOMIC_ACQUIRE)
