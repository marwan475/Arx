...
#define AML_SERIAL_RESOURCE_EXTRA_SIZE(type) (sizeof(struct acpi_resource_serial_##type) - sizeof(struct acpi_resource_serial))

#define NATIVE_SERIAL_RESOURCE_EXTRA_SIZE(type) (sizeof(uacpi_resource_##type##_connection) - sizeof(uacpi_resource_serial_bus_common))
...
static const struct uacpi_resource_convert_instruction convert_io[] = {
        OP(BIT_FIELD_1, AML_F(io, information), NATIVE_F(io, decode_type)), OP(FIELD_16, AML_F(io, minimum), NATIVE_F(io, minimum)), OP(FIELD_16, AML_F(io, maximum), NATIVE_F(io, maximum)),
        OP(FIELD_8, AML_F(io, alignment), NATIVE_F(io, alignment)),         OP(FIELD_8, AML_F(io, length), NATIVE_F(io, length)),    END(),
};
