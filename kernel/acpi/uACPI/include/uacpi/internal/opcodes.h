...
#define UACPI_METHOD_CALL_OPCODE(nargs)                                                                                                                                                                \
    UACPI_OP(InternalOpMethodCall##nargs##Args, 0xF7 + nargs, UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                                                                 \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_LOAD_INLINE_IMM,                                                                                                                                                   \
                     1,                                                                                                                                                                                \
                     nargs,                                                                                                                                                                            \
...
#define UACPI_UNRESOLVED_NAME_STRING_OP(character, code)                                                                                                                                               \
    UACPI_OP(UACPI_InternalOpUnresolvedNameString_##character, code, UACPI_OP_PROPERTY_SIMPLE_NAME | UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TERM_ARG,                                         \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_AML_PC_DECREMENT,                                                                                                                                                  \
                     UACPI_PARSE_OP_EXISTING_NAMESTRING_OR_NULL,                                                                                                                                       \
                     UACPI_PARSE_OP_CONVERT_NAMESTRING,                                                                                                                                                \
...
#define UACPI_BUILD_LOCAL_OR_ARG_OP(prefix, base, offset)                                                                                                                                              \
    UACPI_OP(prefix##offset##Op, base + offset, UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_SIMPLE_NAME,                                                              \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_EMPTY_OBJECT_ALLOC,                                                                                                                                                \
                     UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                    \
                     UACPI_PARSE_OP_OBJECT_TRANSFER_TO_PREV,                                                                                                                                           \
...
#define UACPI_ENUMERATE_OPCODES                                                                                                                                                                        \
    UACPI_OP(ZeroOp, 0x00, UACPI_OP_PROPERTY_TARGET | UACPI_OP_PROPERTY_TERM_ARG,                                                                                                                      \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_LOAD_INLINE_IMM_AS_OBJECT,                                                                                                                                         \
                     0x00,                                                                                                                                                                             \
                     0x00,                                                                                                                                                                             \
    ...
    UACPI_OP(NotifyOp, 0x86, 0,                                                                                                                                                                        \
             {                                                                                                                                                                                         \
                     ...
                     /* SuperName that must evaluate to Device/ThermalZone or */ /* Processor, just ignore for now.                       */                                                           \
                     UACPI_PARSE_OP_EXISTING_NAMESTRING_OR_NULL_IF_LOAD,                                                                                                                               \
                     UACPI_PARSE_OP_OPERAND,                                                                                                                                                           \
                     UACPI_PARSE_OP_SKIP_WITH_WARN_IF_NULL,                                                                                                                                            \
                     0,                                                                                                                                                                                \
    ...
    UACPI_OP(IndexOp, 0x88, UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_SIMPLE_NAME,                                                                                  \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_TERM_ARG_UNWRAP_INTERNAL,                                                                                                                                          \
                     UACPI_PARSE_OP_OPERAND,                                                                                                                                                           \
                     UACPI_PARSE_OP_TARGET,                                                                                                                                                            \
    ...
    UACPI_OP(InternalOpReadFieldAsBuffer, 0xF4, UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                                                                               \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                                                                                                \
                     UACPI_OBJECT_BUFFER,                                                                                                                                                              \
                     UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                    \
    ...
    UACPI_OP(InternalOpReadFieldAsInteger, 0xF5, UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                                                                              \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                                                                                                \
                     UACPI_OBJECT_INTEGER,                                                                                                                                                             \
                     UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                    \
    ...
    UACPI_OP(InternalOpNamedObject, 0xF6, UACPI_OP_PROPERTY_SIMPLE_NAME | UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_RESERVED,                                       \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_EMPTY_OBJECT_ALLOC,                                                                                                                                                \
                     UACPI_PARSE_OP_INVOKE_HANDLER,                                                                                                                                                    \
                     UACPI_PARSE_OP_OBJECT_TRANSFER_TO_PREV,                                                                                                                                           \
...
#define UACPI_ENUMERATE_EXT_OPCODES                                                                                                                                                                    \
    ...
    UACPI_OUT_OF_LINE_OP(LoadTableOp, UACPI_EXT_OP(0x1F), uacpi_load_table_op_decode_ops, UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_OUT_OF_LINE)                                                  \
    UACPI_OUT_OF_LINE_OP(LoadOp, UACPI_EXT_OP(0x20), uacpi_load_op_decode_ops, UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_OUT_OF_LINE)                                                             \
    ...
    UACPI_OP(DebugOp, UACPI_EXT_OP(0x31), UACPI_OP_PROPERTY_TERM_ARG | UACPI_OP_PROPERTY_SUPERNAME | UACPI_OP_PROPERTY_TARGET,                                                                         \
             {                                                                                                                                                                                         \
                     UACPI_PARSE_OP_OBJECT_ALLOC_TYPED,                                                                                                                                                \
                     UACPI_OBJECT_DEBUG,                                                                                                                                                               \
                     UACPI_PARSE_OP_OBJECT_TRANSFER_TO_PREV,                                                                                                                                           \
    ...
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(Processor, 0x83, UACPI_OBJECT_PROCESSOR, UACPI_PARSE_OP_LOAD_IMM, 1, UACPI_PARSE_OP_LOAD_IMM, 4, UACPI_PARSE_OP_LOAD_IMM, 1)                                     \
    UACPI_BUILD_NAMED_SCOPE_OBJECT_OP(PowerRes, 0x84, UACPI_OBJECT_POWER_RESOURCE, UACPI_PARSE_OP_LOAD_IMM, 1, UACPI_PARSE_OP_LOAD_IMM, 2)                                                             \
